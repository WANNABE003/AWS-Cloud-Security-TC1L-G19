-- PostgreSQL seed data for SecureStyle Fashion E-Commerce

-- Password for all users: Password@123
-- Hash: $2a$10$VUkpRGYNXTKhhj9yFjsnReB8mYDGAU0F8B/jzf2HYiiyWT5rdRH4.

INSERT INTO AppUser (UserID, Role, Email, FirstName, LastName, PhoneNumber, AddressLine1, City, State, Postcode, PasswordHash)
VALUES
('USR-ADMIN-001', 'Admin', 'admin@securecart.local', 'Willie Teoh', 'Chin Wei', '0123456789', 'Cyberjaya Office, Persiaran Multimedia', 'Cyberjaya', 'Selangor', '63000', '$2a$10$VUkpRGYNXTKhhj9yFjsnReB8mYDGAU0F8B/jzf2HYiiyWT5rdRH4.'),
('USR-OFFICER-001', 'InventoryOfficer', 'officer@securecart.local', 'Lam', 'Rong Yi', '0132223344', 'Warehouse A, Jalan Teknologi', 'Petaling Jaya', 'Selangor', '47810', '$2a$10$VUkpRGYNXTKhhj9yFjsnReB8mYDGAU0F8B/jzf2HYiiyWT5rdRH4.'),
('USR-CUST-001', 'Customer', 'customer@securecart.local', 'Lee', 'Yu Jie', '0145556677', '12 Jalan Harmoni', 'Kuala Lumpur', 'WP Kuala Lumpur', '50480', '$2a$10$VUkpRGYNXTKhhj9yFjsnReB8mYDGAU0F8B/jzf2HYiiyWT5rdRH4.');
